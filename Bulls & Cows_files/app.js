...
Game.createValues = function (){
	...
	for (var i = 0 ; i < Game.buildBoxes; i ++){
		$("#boxes").append("<input type='number' id='num"+ i +"' class='numbers' min='0' max='9'>");
	...
	Game.countAnimals = function(playerGo){
		var soundsArray = ["sounds/You%20In%20Trouble.mp3","sounds/Quit%20Playing%20Ear%20Copy.mp3","sounds/Ass%20is%20dead.mp3","sounds/Ass%20in%20a%20Taco.mp3","sounds/New%20Recording.mp3"];
